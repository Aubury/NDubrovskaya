...
з попередньою різниця:
поправив те що просили в muhoboika
виправив поломку cron з сайтами типу копакова
трохи ще доробив відправку з адреси щоб менше запитів робилось на api новох пошти
[+] попередження про необхідність синхронізації бази відділень (edited)

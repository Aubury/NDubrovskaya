 ...
 */
 ...
 function logiftestpage($stringtolog, $variabletolog){//using html5 details tag
  if( isset ($_GET['test']) || $_GET['page']=='morkvanp_invoice'){
    echo '<details>
...
function novaposhta_updbasesnp(){
 ...
 class NovattnPoshta extends Base
 {
     ...
     public function scripts()
  {
     ...
     wp_register_script( 'select2', NOVA_POSHTA_TTN_SHIPPING_PLUGIN_URL.'/assets/select2.min.js');

...
function formblock_address_recipient($shipping_first_name,$shipping_last_name, $city,$order_data_billing ,$order_data_shipping, $shipping_phone){
  ...
  $city = ( !empty($order_data_shipping['city']) ) ? $order_data_shipping['city'] : $order_data_billing['city'];
  $address = ( !empty($order_data_shipping['address_1']) ) ? $shipping_address : $billing_address;
  $building = ( !empty($order_data_shipping['address_2']) ) ? $shipping_build : $billing_build;
  $flat = ( !empty($order_data_shipping['address_2']) ) ? $order_data_shipping['address_2'] : $order_data_billing['address_2'];
  ...
  echo "<tr>
   ...
   <tr>
     ...
     <tr>
        <th scope=row>
          <label for=\"RecipientAddressName\">Адреса: Вулиця, будинок, квартира</label>
        </th>
        <td>
         <input id=\"RecipientAddressName\" type=\"text\" name=\"invoice_recipient_warehouse\" class=\"input recipient_region\" value='".$address."' />
		 <input id=\"RecipientAddressName\" type=\"hidden\" name=\"invoice_recipient_building\" class=\"input recipient_region\" value='' />
		  <input id=\"RecipientAddressName\" type=\"hidden\" name=\"invoice_recipient_flat\" class=\"input recipient_region\" value='' />
      </tr>

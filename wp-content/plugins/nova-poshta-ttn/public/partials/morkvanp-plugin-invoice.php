		...
		if ( $err ) {
			...
			if(get_option('woocommerce_nova_poshta_sender_address_type')){
				...
				if (!empty( $obj["data"][0]["Description"] ) ){
					...
					$this->recipient_address_flat =  get_option('woocommerce_nova_poshta_sender_flat');
				}
			}
			else{
				$r = json_decode($response);
					...
					$this->recipient_address_flat =  get_option('woocommerce_nova_poshta_sender_flat') ?: get_option('woocommerce_nova_poshta_sender_flat') ;
